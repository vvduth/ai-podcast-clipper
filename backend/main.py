...
def process_clip(base_dir: str, original_video_path: str,
    ...
    create_subtitles_with_ffmpeg(
        transcript_segments, start_time, end_time, vertical_mp4_path, subtitle_output_path,
        max_words=5
    )

    # upload to S3
    s3_client = boto3.client("s3")
    s3_client.upload_file(subtitle_output_path, "ai-podcast-clipper-dukem", output_s3_key)
